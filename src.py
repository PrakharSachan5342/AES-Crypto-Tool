...
cprint('{} {}'.format(space_count + 3 * ' ', 'Programmed by Prakhar Sachan.'), 'green')
...
while True:
 ...
 |___/\___\__|_|  \_, | .__/\__|_\___/_||_|
        ...
        print('Your choice of selection is not available. Please enter 1, 2, or 3.')
